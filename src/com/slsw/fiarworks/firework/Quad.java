...
public class Quad
{
	...
	Quad(Spark s)
	{
		...
		t1 = new Vec3(0.0f, 0.0f, 0.0f);
		t2 = new Vec3(1.0f, 0.0f, 0.0f);
		t3 = new Vec3(0.0f, 1.0f, 0.0f);
		t4 = new Vec3(1.0f, 1.0f, 0.0f);
...
<<<<<<< HEAD:newapp/src/com/slsw/fiarworks/firework/Quad.java
	public void set_quad(float[] buffer, int offset, float[] tex_coord_buffer, int tex_coord_offset)
=======
	public void set_quad(float[] buffer, int offset, float[] tex_buffer, int tex_offset)
>>>>>>> 1f58e7643637ff32b8f64584501cd873c89623a7:src/com/slsw/fiarworks/firework/Quad.java
	{
...
=======
		set_tex(tex_buffer, tex_offset + 0, t1);
		set_tex(tex_buffer, tex_offset + 2, t3);
		set_tex(tex_buffer, tex_offset + 4, t2);
		set_tex(tex_buffer, tex_offset + 6, t4);
		set_tex(tex_buffer, tex_offset + 8, t3);
		set_tex(tex_buffer, tex_offset + 10, t2);
>>>>>>> 1f58e7643637ff32b8f64584501cd873c89623a7:src/com/slsw/fiarworks/firework/Quad.java
	}
...
<<<<<<< HEAD:newapp/src/com/slsw/fiarworks/firework/Quad.java
	...
	private void set_texture(float[] buffer, int offset, float a, float b)
	{
		...
		buffer[offset + 1] = b;
=======
	private void set_tex(float[] buffer, int offset, Vec3 t)
	{
		buffer[offset + 0] = t.x;
		buffer[offset + 1] = t.y;
>>>>>>> 1f58e7643637ff32b8f64584501cd873c89623a7:src/com/slsw/fiarworks/firework/Quad.java
